...
import { Plus, CheckCircle2, Clock, AlertCircle, UserPlus, Filter } from "lucide-react";
...
const initial: Task[] = [
  { id: "T-101", titulo: "Confirmar 14 consultas de quinta", responsavel: "Juliana Reis", prioridade: "alta", prazo: "Hoje 18:00", status: "andamento" },
  { id: "T-102", titulo: "Enviar atestados pendentes", responsavel: "Ana Lima", prioridade: "media", prazo: "Amanhã", status: "pendente" },
  { id: "T-103", titulo: "Revisar fila de pagamento Pix", responsavel: "Carlos Mendes", prioridade: "alta", prazo: "Hoje 16:00", status: "pendente" },
  { id: "T-104", titulo: "Atualizar dados Construtora Horizonte", responsavel: "Renata Albuquerque", prioridade: "baixa", prazo: "30/Abr", status: "andamento" },
  { id: "T-105", titulo: "Treinar equipe no novo bot", responsavel: "Fernanda Lasmar", prioridade: "media", prazo: "02/Mai", status: "concluida" },
];
...
export default function Tarefas() {
  ...
  const create = () => {
    ...
    setTasks(ts => [
      { id: `T-${100 + ts.length + 1}`, ...novo, status: "pendente" },
      ...ts,
    ]);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Atribua, monitore e conclua atividades operacionais da equipe."
        actions={
            ...
            {filtered.map(t => {
              ...
              return (
                <tr key={t.id} className="border-t border-border hover:bg-muted/30">
                  ...
                  <td className="p-3 text-muted-foreground">{t.prazo}</td>
                  <td className="p-3">
                  ...
                  <td className="p-3 text-right">
                    <Button size="sm" variant="ghost" onClick={() => advance(t)}>
                      Avançar
                    </Button>
