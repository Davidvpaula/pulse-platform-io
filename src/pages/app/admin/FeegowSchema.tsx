...
const endpoints: EndpointInfo[] = [
  ...
  { path: "/laudos/list", method: "GET", status: "nao_testado", statusDetail: "Permissão pendente na instância Feegow (configuração externa)" },
  { path: "/patient/prescriptions", method: "GET", status: "nao_testado", statusDetail: "Permissão pendente na instância Feegow (configuração externa)" },
