...
export function MedicoLoading({ message = "Carregando…" }: { message?: string }) {
  return (
...
export function MedicoError({ message, onRetry }: { message?: string; onRetry?: () => void }) {
  return (
...
export function MedicoEmpty({ icon: Icon = Inbox, title, description }: {
...
export function MedicoInlineLoading() {
  return (
